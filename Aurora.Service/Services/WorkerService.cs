...
{
    public class WorkerService : ServiceWorker
    {
        private readonly RepositoryWorker _repositoryUser;
        private readonly NotificationContext _notificationContext;

        public WorkerService(RepositoryWorker repositoryUser, NotificationContext notificationContext)
        {
